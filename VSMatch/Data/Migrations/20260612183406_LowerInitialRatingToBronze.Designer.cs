...
namespace VSMatch.Data.Migrations
{
    ...
    [Migration("20260612183406_LowerInitialRatingToBronze")]
    partial class LowerInitialRatingToBronze
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VSMatch.Data.Entities.Court", b =>
                {
                    ...
                    b.HasIndex("SportKind");

                    b.ToTable("Courts");
                });

            modelBuilder.Entity("VSMatch.Data.Entities.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VSMatch.Data.Entities.UserRating", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("Rating")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double precision")
                        .HasDefaultValue(750.0);

                    b.HasKey("UserId", "Sport");
